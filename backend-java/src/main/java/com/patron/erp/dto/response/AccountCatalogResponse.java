...
public class AccountCatalogResponse {
    private String id;
    ...
    private List<AccountCatalogResponse> hijos;
    ...
    public List<AccountCatalogResponse> getHijos() { return hijos; }
    public void setHijos(List<AccountCatalogResponse> hijos) { this.hijos = hijos; }
}
